...
public class ExceptionRun {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * - 런타임 에러 : 코드 상으로 문제가 없어보임(육안으로) 프로그램 실행 중에 발생하는 에러 (사용자의 실수일 수도 있고 개발자의 실수일 수도 있다 > 예외처리) 
		 * 
		 * - 논리 에러 : 문법적으로 문제없고 실행했을 때도 굳이 문제 없지만 프로그램 의도상 맞지않는 것
		 * 
		 * 시스템 에러를 제외한 컴파일 에러, 런타임 에러, 논리 에러와 같은 비교적 덜 심각한 것들을 "예외(Exception)"라고 함!!!
		 * 
