...
public class InetRun {
	...
	public static void main(String[] args) {
		...
		/*
		 * < 네트워크(Network) >
		 *  여러대 컴퓨터들이 연결되어 있는 통신망 같은거 => 이런 네트워크를 통해 서로간의 데이터 교환 가능!
		 *  
		 ...
		 *  
		 *  서버에 요청하기 위해서는 그 요청하고자 하는 서버의 IP주소(또는 도메인명), 포트 번호 알아야됨! 
		 * 
		 */
		...
		try {
			...
			System.out.println(localHost); // '내 PC명 / 내 IP주소'  출력
			
			System.out.println("내 pc명 : " + localHost.getHostName()); // 내 PC명 반환 메소드
			System.out.println("내 ip주소 : " + localHost.getHostAddress()); // ip 주소 반환 메소드
	 ...
	 *  
	 *  자바만을 가지고 서버와 클라이언트간의 간단한 통신 해보기
	 *  이때 데이터를 입출력하고자한다면 서버와 클라이언트간의 스트림(연결통로)이 필요함!
	 *  
	 ...
	 *  - UDP 방식 : 데이터 전송속도가 빠름! 신뢰성 없는 데이터 전달 될 수 있음! (데이터를 빠른 속도로 전송하고자 하는 프로그램 : 실시간 동영상 서비스)
	 *  
	 */
